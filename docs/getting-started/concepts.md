...
### Authentication
- Satellite authentication with Ground Control
...
1. **Group Organization**
   - Organize related artifacts into logical groups
...
2. [Configuration Guide](../user-guide/configuration.md) - Configure your deployment
3. [User Guide](../user-guide/README.md) - Learn how to use Harbor Satellite
4. [Architecture Guide](../architecture/overview.md) - Understand the system architecture 