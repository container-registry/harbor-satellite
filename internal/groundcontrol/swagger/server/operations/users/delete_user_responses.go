...
// DeleteUserBadRequest User cannot be deleted by this request.
//
...
func (o *DeleteUserBadRequest) WithPayload(payload *models.AppError) *DeleteUserBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete user bad request response
func (o *DeleteUserBadRequest) SetPayload(payload *models.AppError) {
	o.Payload = payload
}
...
// DeleteUserUnauthorized Authorization token is missing or invalid.
//
...
func (o *DeleteUserUnauthorized) WithPayload(payload *models.AppError) *DeleteUserUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete user unauthorized response
func (o *DeleteUserUnauthorized) SetPayload(payload *models.AppError) {
	o.Payload = payload
}
...
// DeleteUserForbidden System administrator role is required.
//
...
func (o *DeleteUserForbidden) WithPayload(payload *models.AppError) *DeleteUserForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete user forbidden response
func (o *DeleteUserForbidden) SetPayload(payload *models.AppError) {
	o.Payload = payload
}
...
// DeleteUserNotFound User was not found.
//
...
func (o *DeleteUserNotFound) WithPayload(payload *models.AppError) *DeleteUserNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete user not found response
func (o *DeleteUserNotFound) SetPayload(payload *models.AppError) {
	o.Payload = payload
}
...
// DeleteUserInternalServerError User could not be deleted.
//
...
func (o *DeleteUserInternalServerError) WithPayload(payload *models.AppError) *DeleteUserInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete user internal server error response
func (o *DeleteUserInternalServerError) SetPayload(payload *models.AppError) {
	o.Payload = payload
}
