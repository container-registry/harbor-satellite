...
type BasicReplicator struct {
	...
	use_unsecure bool
	zot_url      string
	state_reader state.StateReader
}
...
func NewReplicator(state_reader state.StateReader) Replicator {
...
func (r *BasicReplicator) Rep(ctx context.Context, image string) error {
