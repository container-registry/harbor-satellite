...
// NewScheduler creates a new scheduler with the given ticker and process
func NewScheduler(ticker *time.Ticker, process Process, log *zerolog.Logger) *Scheduler {
	return &Scheduler{
		ticker:  ticker,
		process: process,
		log:     log,
